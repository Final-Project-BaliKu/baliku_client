        ...
        <div className="min-h-screen sm:flex sm:flex-row mx-0 justify-center">
          <div className="flex-col flex  self-center p-10 sm:max-w-5xl xl:max-w-2xl  z-10">
            <div className="self-start hidden lg:flex flex-col  text-white">
              <h1 className="mb-3 font-bold text-5xl">Hi <img src={logo} alt="img" style={{ width: 80, display: 'inline-block' }} /> Welcome to baliKu </h1>
          ...
          <div className="flex justify-center self-center  z-10">
            <div className="p-12 bg-white mx-auto rounded-lg w-100 relative overflow-hidden">
              ...
              <div className="space-y-5">
                ...
                <div>
                  <button onClick={enter} className="w-full flex justify-center bg-blue-900  hover:bg-blue-500 text-gray-100 p-3  rounded tracking-wide font-semibold  shadow-lg cursor-pointer transition ease-in duration-500">
                    Sign in
                  </button>
                </div>
              </div>
